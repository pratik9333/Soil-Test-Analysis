    ...
    <div class="modal fade" id="signup" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="farmer.php" method="post" id="formSubmit">
                    <div class="modal-body" id="modal-body">
                        <span style="color:red" class="errors"></span>
                        <div class="form-group" id="form">
                            <label for="name">Enter name (नाम भरें)</label>
                            <input type="text" oninput="this.className = 'form-control'" class="form-control"
                                name="name" id="name" required>
                        </div>
                        <div class="form-group">
                            <label for="age">Enter age (आयु दर्ज करें)</label>
                            <input type="number" oninput="this.className = 'form-control'" class="form-control"
                                name="age" id="age" required>
                        </div>
                        <div class="form-group">
                            <label for="age">Enter Address (पता लिखिए)</label>
                            <textarea name="address" oninput="this.className = 'form-control'" class="form-control" id="address" cols="4" rows="6"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="aadhaar">Enter aadhaar number (आधार नंबर दर्ज करें)</label>
                            <input type="number" oninput="this.className = 'form-control'" class="form-control"
                                name="aadhaar" id="aadhaar" required>
                        </div>
                        <div class="form-group">
                            <label for="contact">Enter contact number (संपर्क नंबर दर्ज करें)</label>

                            <input type="mobile" oninput="this.className = 'form-control'" class="form-control"
                                name="contact" id="contact" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Enter email (ईमेल दर्ज करें)</label>

                            <input type="text" oninput="this.className = 'form-control'" class="form-control"
                                name="email" id="email" required>
                        </div>
                        <div class="form-group">
                            <label for="password">Enter password (पासवर्ड दर्ज करें)</label>
                            <input type="password" oninput="this.className = 'form-control'" class="form-control"
                                name="password" id="fpassword" required>
                        </div>
                        <div class="form-group">
                            <label for="password">Enter confirm password (पासवर्ड की पुष्टि करें)</label>
                            <input type="password" oninput="this.className = 'form-control'" class="form-control"
                                id="lpassword" required>
                        </div>
                        <div class="form-group">
                            <button type="submit" onclick="req()" id="signup" name="submit" class="btn btn-primary px-4 py-2">Sign
                                up</button>
                        </div>
    ...
    <div class="modal fade" id="loginmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="farmer.php" id="loginForm" method="post">
                    <div class="modal-body">
                        <span class="l_errors" style="color: red;display: block;"></span>
                        <div class="form-group">
                            <label for="email">Enter email (ईमेल दर्ज करें)</label>
                            <input type="text" oninput="this.className = 'form-control'" class="form-control"
                        ...
                        <div class="form-group">
                            <button type="submit" onclick="req()" name="l_submit" class="btn btn-primary px-4 py-2">Log
                                in</button>
                        </div>
                        <div class="form-group text-center">
        ...
        <div class="container text-center pt-5">
            <div class="row pt-5 justify-content-center">
                <div class="col-md-5 mt-sm-0 mt-md-5">
                    <h1 class="header text-white font-weight-light display-5">Farmer Services</h1>
                    <p class=" para text-white mt-4">Welcome to farmer section, here farmer can start its activity by creating a new account. As soon as he sign up, he/she can log in and get started. A detailed
                        Services for you is given in this section make sure you read it properly before moving on. Have a great day!</p>
                </div>
                <div class="col-md-6 offset-md-1 mt-5 mt-md-0">
                    <img src="./images/farmer.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="services-list pt-40">
                        <button class="services-item">
                            ...
                            <div class="services-text">
                                ...
                                <p class="services-desc">A farmer can easily made a free account and can start
                                    its work.</p>
                            </div>
                        </button>
                        <button class="services-item">
                            ...
                            <div class="services-text">
                                ...
                                <p class="services-desc">Fast alerts from lab assistants whether they generated test report or not.</p>
                            </div>
                        </button>
                        <button class="services-item">
                            ...
                            <div class="services-text">
                                ...
                                <p class="services-desc">A farmer can see detailed status about their soil testing. Not approved, approved and tested.</p>
                            </div>
                        </button>
                        <button class="services-item">
                            ...
                            <div class="services-text">
                                ...
                                <p class="services-desc">A farmer can easily download a report as generated by the lab assistant after the success of soil testing and report generating at lab assistants end.</p>
                            </div>
                        </button>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-center how-it-works">
                    ...
                    <div class="col-10">
                        ...
                        <p class="lead">
                            A farmer has to first create a new account to get started and then he/she can <br> log in through personal creditentials!
                        </p>
                    </div>
                </div>
                <!--path between 1-2-->
                ...
                <div class="row align-items-center justify-content-end how-it-works">
                    <div class="col-10 text-right">
                        <h2 style="font-weight:900; font-size: 1.8rem;letter-spacing: 1px;">Create Test!</h2>
                        <p class="lead">
                            As soon as he/she signed in a farmer has to create a test by click create test option. <br> As soon as he clicks a farmer has to write some description about its test and as soon <br> as he submitted a test would be generated!
                        </p>
                    </div>
                ...
                <div class="row align-items-center how-it-works">
                    ...
                    <div class="col-10">
                        <h2 style="font-weight:900; font-size: 1.8rem;letter-spacing: 1px;">Check Status!</h2>
                        <p class="lead">
                            As soon as a test is generated, now a farmer can see his all information along with status <br> in the dashboard/home page. A farmer can check status and as soon as a report is been <br> tested from lab's end, a farmer will get status of tested and now he/she can download <br> its test report.
                        </p>
                    </div>
                </div>
                <!-- path between 3-4 -->
                ...
                <div class="row align-items-center justify-content-end how-it-works">
                    <div class="col-10 text-right">
                        ...
                        <p class="lead">
                            Yes, you heard it right, It's as easy as possible! Now a farmer can  log out <br>from its account.
                        </p>
                    </div>
                    <div class="col-2 text-center full">
...
if(isset($_POST['submit'])){
    ...
    $q="select * from farmer where Email ='$email' || Aadhar =$aadhaar";
    $result=mysqli_query($con,$q);
    $num=mysqli_num_rows($result);
    if($num==0){
        $insert="insert into farmer(Name,Age,Address,Aadhar,Contact,Email,password) values('$name',$age,'$address',$aadhaar,'$contact','$email',$password)";
...
if(isset($_POST['l_submit'])){
    ...
    $con=mysqli_connect("localhost","root","");
    mysqli_select_db($con,"soil_test_analysis");
    $q="select * from farmer where Email ='$l_email' && password ='$l_password'";   
    $result=mysqli_query($con,$q);
