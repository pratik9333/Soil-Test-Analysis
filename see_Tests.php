    ...
    <section class="tests mt-5">
        <div class="container-fluid pt-5">
            <table class="table table-striped table-bordered table-hover">
                ...
                ?>
                <form action="report_PDF.php" method="post">
                ...
                <tr>
                    ...
                    <td><button name="report" class="btn btn-primary">Generate Report</button></td>
                </tr>
                </form>
                <?php
				    }
...
<script>
    ...
    let y=document.getElementsByName("report");
